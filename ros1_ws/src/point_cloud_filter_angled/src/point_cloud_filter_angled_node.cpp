...
class PointCloudFilterAngled {
public:
    PointCloudFilterAngled() {
        // Initialize ROS node
        ros::NodeHandle nh;

        // Subscribe to the input PointCloud2 topic
        pointcloud_sub = nh.subscribe("/pcl_filter_input", 1, &PointCloudFilterAngled::pointCloudCallback, this);
        ...
        nh.param<double>("/angle_max", angle_max_, 45.0);
    }
...
private:
    ...
    void pointCloudCallback(const sensor_msgs::PointCloud2ConstPtr& cloud_msg) {
        ...
        {
            ROS_INFO("No points in the filtered point cloud.");
            return;
        }
        ...
        for (int i = 0; i < (*cloud_filtered).size(); i++)
        {
            ...
            float angle = atan2(pt.x, pt.z)*180/3.14159;
            if (abs(angle) > angle_max_) {
...
int main(int argc, char** argv) {
    ...
    // Create the PointCloudFilterAngled object
    PointCloudFilterAngled PointCloudFilterAngled;
